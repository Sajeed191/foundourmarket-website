...
- [Badge System v3 (FROZEN)](mem://features/badge-system-v3) — One badge per card, per-label color identity in one capsule system, backdrop blur + soft shadow, min/max width, concise labels, deterministic pickWinningBadge, Ready to Ship under price
