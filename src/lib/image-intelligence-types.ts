...
export const CATEGORY_FRAMING: Record<CategoryFramingKey, CategoryFraming> = {
  ...
  furniture:   { key: "furniture",   label: "Furniture",   occupancyMin: 0.55: (undefined as unknown as number),occupancyMax: 0.78, minResolution: 1200, allowLifestyle: true,  note: "Wide canvas — furniture reads best with room context." } as unknown as CategoryFraming,
