  ...
  head: () => ({
    meta: [
      ...
      { name: "robots", content: "noindex, nofollow" },
      {
        name: "description",
        content:
          "Sign in or create your FoundOurMarket account to track orders, save wishlists, and enjoy a faster, personalized checkout.",
      },
      { property: "og:title", content: "Sign In — FoundOurMarket™" },
      {
        property: "og:description",
        content: "Access your FoundOurMarket account to track orders and check out faster.",
      },
...
function AuthPage() {
  ...
  return (
    <div
      className="relative min-h-screen flex items-center justify-center px-5 py-6 sm:py-10 overflow-hidden"
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
        ...
        />
        <div
          className="absolute bottom-[2%] right-[-10%] w-[55vw] max-w-[480px] h-[40vh] rounded-full opacity-[0.14]"
          style={{
      ...
      >
        ...
        <div className="flex flex-col items-center mb-5">
          <div className="relative mb-3.5">
            ...
            <motion.div
              ...
              style={{
                background: "radial-gradient(circle, rgba(255,122,0,0.45) 0%, transparent 65%)",
                filter: "blur(22px)",
              }}
            />
          ...
          <p
            className="text-[10px] font-mono uppercase tracking-[0.38em] mb-0.5"
            style={{ color: "#FF9F43" }}
          >
            FoundOurMarket™
          </p>
        ...
        {mode === "oauth" && !oauthReturnPending && (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(255,159,67,0.06) 0%, rgba(255,255,255,0.025) 50%, rgba(255,122,0,0.04) 100%)",
            }}
          >
            {/* edge light */}
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(255,159,67,0.5), transparent)",
              }}
            />
            ...
            <ul className="space-y-2">
              {BENEFITS.map(({ icon: Icon, label }, i) => (
                ...
                >
                  <span
                    className="shrink-0 size-7 rounded-lg grid place-items-center ring-1 ring-[#FF7A00]/20 shadow-[0_0_12px_-4px_rgba(255,122,0,0.5)]"
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(255,122,0,0.18), rgba(255,159,67,0.08))",
                      color: "#FFB369",
                    }}
                  >
        ...
        {mode === "oauth" && oauthReturnPending && (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(255,159,67,0.06) 0%, rgba(255,255,255,0.025) 100%)",
            }}
          >
        ...
        >
          <span
            className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 ring-1 ring-white/[0.07] backdrop-blur-md"
            style={{ background: "rgba(255,255,255,0.025)" }}
          >
            <span
              className="size-1.5 rounded-full"
              style={{ background: "#FF9F43", boxShadow: "0 0 8px #FF9F43" }}
            />
        ...
        <p className="text-center mt-3">
          <Link to="/" className="text-[11px] text-white/35 hover:text-white/65 transition-colors">
            ← Back to shop
          </Link>
        </p>
      </motion.div>
