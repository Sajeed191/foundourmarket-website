  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="flex items-end justify-between flex-wrap gap-4 mb-12">
        <h1 className="text-3xl md:text-5xl font-display font-semibold">Address book</h1>
      ...
      {aLoading ? (
        ...
        <ul className="grid sm:grid-cols-2 gap-4">
          {addresses.map((a) => (
            <li key={a.id} className="bg-card border border-border rounded-2xl p-5 flex flex-col">
              ...
              <div className="mt-auto pt-4 flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  aria-label="Edit"
                  className="ml-auto size-8 grid place-items-center rounded-full border border-border hover:text-accent hover:border-accent/40 transition-colors"
                >
                  <Pencil className="size-3.5" />
                </button>
                <button
                  onClick={() => {
                    if (confirm("Delete this address?")) remove(a.id);
                  }}
                  aria-label="Delete"
                  className="size-8 grid place-items-center rounded-full border border-border hover:text-destructive hover:border-destructive/40 transition-colors"
                >
