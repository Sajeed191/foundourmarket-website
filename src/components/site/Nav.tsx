      ...
      >
        <nav className="max-w-7xl mx-auto rounded-2xl glass-strong shadow-[var(--shadow-float)] ring-1 ring-white/10">
          <div className="flex items-center justify-between px-2.5 sm:px-5 py-2.5 sm:py-3 gap-1.5 sm:gap-2">
            ...
            <Link
              to="/"
              className="min-w-0 flex-1 md:flex-none flex items-center gap-2 sm:gap-2.5 font-display tracking-tight font-semibold"
            >
              <span className="shrink-0 relative inline-grid place-items-center size-11 sm:size-12 rounded-2xl bg-black/40 ring-1 ring-white/10 overflow-hidden shadow-[0_0_22px_-4px_var(--color-accent)]">
              ...
              <span className="min-w-0 flex flex-col leading-none">
                <span className="truncate text-[15px] sm:text-lg">
                  FoundOurMarket<span className="text-accent">™</span>
                </span>
                <span className="mt-0.5 text-[9px] sm:text-[10px] font-mono uppercase tracking-[0.22em] text-muted-foreground">
                  Global Marketplace
                </span>
              </span>
            </Link>
